# 🔧 Troubleshooting Guide — IDP Template Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-idp-template/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/idp-template/)
