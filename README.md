# 📦 IDP Template Studio
> Scaffold Backstage service catalog metadata and developer software scaffolding templates.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/idp-template/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/idp-template/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-idp-template.git
cd tp-idp-template
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/idp-template/) |
